...
API_URL = "https://app.uniteagency.uz/api.php"
...
async def register_user_remote(chat_id, username):
    """Сохраняем пользователя на ahost через API"""
    import aiohttp
    try:
...
async def start(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    await register_user_remote(chat_id, username)
